    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="jingsaiCollectionTypes">
                        <el-select v-model="ruleForm.jingsaiCollectionTypes" :disabled="ro.jingsaiCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in jingsaiCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="jingsaiCollectionValue">
                        <el-input v-model="ruleForm.jingsaiCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    jingsaiId: false,
                    yonghuId: false,
                    jingsaiCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    jingsaiId: '',
                    yonghuId: '',
                    jingsaiCollectionTypes: '',
                    insertTime: '',
                },
                jingsaiCollectionTypesOptions : [],
                jingsaiOptions : [],
                yonghuOptions : [],
                rules: {
                   jingsaiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jingsai_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jingsaiCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jingsaiCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jingsaiCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
