               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="指导老师姓名" prop="zhidaolaoshiName">
                       <el-input v-model="ruleForm.zhidaolaoshiName"
                                 placeholder="指导老师姓名" clearable  :readonly="ro.zhidaolaoshiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="指导老师手机号" prop="zhidaolaoshiPhone">
                       <el-input v-model="ruleForm.zhidaolaoshiPhone"
                                 placeholder="指导老师手机号" clearable  :readonly="ro.zhidaolaoshiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="指导老师身份证号" prop="zhidaolaoshiIdNumber">
                       <el-input v-model="ruleForm.zhidaolaoshiIdNumber"
                                 placeholder="指导老师身份证号" clearable  :readonly="ro.zhidaolaoshiIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.zhidaolaoshiPhoto" label="指导老师头像" prop="zhidaolaoshiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.zhidaolaoshiPhoto?$base.url+ruleForm.zhidaolaoshiPhoto:''"
                            @change="zhidaolaoshiPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="指导老师邮箱" prop="zhidaolaoshiEmail">
                       <el-input v-model="ruleForm.zhidaolaoshiEmail"
                                 placeholder="指导老师邮箱" clearable  :readonly="ro.zhidaolaoshiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    zhidaolaoshiName: false,
                    zhidaolaoshiPhone: false,
                    zhidaolaoshiIdNumber: false,
                    zhidaolaoshiPhoto: false,
                    sexTypes: false,
                    zhidaolaoshiEmail: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   zhidaolaoshiIdNumber: [
                              { required: true, message: '指导老师身份证号不能为空', trigger: 'blur' },
                              { pattern: /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
                                message: '指导老师身份证号格式有误！',
                                trigger: 'blur'
                              }
                          ],
                   zhidaolaoshiPhoto: [
                              { required: true, message: '指导老师头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   zhidaolaoshiEmail: [
                              { required: true, message: '指导老师邮箱不能为空', trigger: 'blur' },
                              { pattern: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/,
                                message: '指导老师邮箱只能是邮箱格式',
                                trigger: 'blur'
                              }
                          ],
                }
        ...
        methods: {
            ...
            //图片
            zhidaolaoshiPhotoUploadChange(fileUrls){
                this.ruleForm.zhidaolaoshiPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
