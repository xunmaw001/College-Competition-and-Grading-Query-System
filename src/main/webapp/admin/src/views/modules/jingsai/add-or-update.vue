        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="报名截止时间" prop="baomingjiezhiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.baomingjiezhiTime"
                                type="datetime"
                                placeholder="报名截止时间"
                                :disabled="ro.baomingjiezhiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.baomingjiezhiTime" label="报名截止时间" prop="baomingjiezhiTime">
                            <span v-html="ruleForm.baomingjiezhiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="竞赛内容" prop="jingsaiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jingsaiContent" label="竞赛内容" prop="jingsaiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jingsaiContent: [
                              { required: true, message: '竞赛内容不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
