        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaojingsai/upload/jingsaiMuBan.xls"
                        >批量导入竞赛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jingsai','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="jingsaiClicknum"
                                      header-align="center"
                                      label="竞赛热度">
                        <template slot-scope="scope">
                            {{scope.row.jingsaiClicknum}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="baomingjiezhiTime"
                                   header-align="center"
                                   label="报名截止时间">
                        <template slot-scope="scope">
                            {{scope.row.baomingjiezhiTime}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                jingsaiPhoto : null,
                jingsaiTypes : null,
                jingsaiClicknum : null,
                baomingjiezhiTime : null,
                jingsaiContent : null,
                insertTime : null,
                createTime : null,
            },
