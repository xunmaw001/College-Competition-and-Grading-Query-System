    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(jingsai !=null){
            ...
            //级联表 学生
            //级联表
            YonghuEntity yonghu = yonghuService.selectById(jingsai.getYonghuId());
            if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody JingsaiEntity jingsai, HttpServletRequest request){
        ...
        if(false)
            ...
            jingsai.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<JingsaiEntity> queryWrapper = new EntityWrapper<JingsaiEntity>()
            .eq("yonghu_id", jingsai.getYonghuId())
...
//                            jingsaiEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
...
//                            jingsaiEntity.setBaomingjiezhiTime(sdf.parse(data.get(0)));          //报名截止时间 要改的
...
//                            jingsaiEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //竞赛编号
                        List<JingsaiEntity> jingsaiEntities_jingsaiUuidNumber = jingsaiService.selectList(new EntityWrapper<JingsaiEntity>().in("jingsai_uuid_number", seachFields.get("jingsaiUuidNumber")));
