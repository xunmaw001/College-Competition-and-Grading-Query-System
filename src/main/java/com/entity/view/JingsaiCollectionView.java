...
import com.entity.JingsaiCollectionEntity;
...
public class JingsaiCollectionView extends JingsaiCollectionEntity implements Serializable {
	...
	*/
	...
	private String jingsaiCollectionValue;
	...
	public JingsaiCollectionView() {

	}

	public JingsaiCollectionView(JingsaiCollectionEntity jingsaiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jingsaiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getJingsaiCollectionValue() {
		return jingsaiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setJingsaiCollectionValue(String jingsaiCollectionValue) {
		this.jingsaiCollectionValue = jingsaiCollectionValue;
	}
	...
	public String toString() {
		return "JingsaiCollectionView{" +
			", jingsaiCollectionValue=" + jingsaiCollectionValue +
