...
public class JingsaiLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JingsaiLiuyanEntity() {

	}

	public JingsaiLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "jingsai_liuyan_text")

    private String jingsaiLiuyanText;
	 ...
	 * 获取：留言内容
	 */
    public String getJingsaiLiuyanText() {
        return jingsaiLiuyanText;
    }
    /**
	 * 设置：留言内容
	 */

    public void setJingsaiLiuyanText(String jingsaiLiuyanText) {
        this.jingsaiLiuyanText = jingsaiLiuyanText;
    }
    /**
	 * 获取：留言时间
	 */
    ...
    public String toString() {
        return "JingsaiLiuyan{" +
            ", id=" + id +
            ", jingsaiId=" + jingsaiId +
            ", yonghuId=" + yonghuId +
            ", jingsaiLiuyanText=" + jingsaiLiuyanText +
